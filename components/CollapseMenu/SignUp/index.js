        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <form className="text-center" onSubmit={validate}>
                <TextField className="mx-2 mt-4" fullWidth variant="standard" error={email.error} type={"email"} label={"Your email address"} required name="email" value={email.data} onChange={emailChange} />
