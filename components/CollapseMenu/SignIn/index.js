...
export default function SignIn() {
  return (
    <div class="modal fade text-dark" id="signInForm">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="/" method="POST" className="text-center">
                <TextField className="mx-2" fullWidth variant="standard" type={"text"} label={<i class="fa-solid fa-user"></i>} required name="username"/>
                <TextField className="mx-2 mt-4" fullWidth variant="standard" type={"password"} label={<i class="fa-solid fa-key"></i>} name="password" required/>
